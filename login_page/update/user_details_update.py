...
@router.put("/User/user_data_update/{username}",response_model=Show_User_Update)
def user_data_update (username :str,updates: UpdateUser,db:session=Depends(get_db)):
